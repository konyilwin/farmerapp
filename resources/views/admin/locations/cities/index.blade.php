...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.cities.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-cities">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.cities.fields.id') }}
                        </th>
                        <th>
                            {{ trans('cruds.cities.fields.division') }}
                        </th>
                        <th>
                            {{ trans('cruds.cities.fields.name') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
...
<script>
  ...
  $('.datatable-cities:not(.ajaxTable)').DataTable({ buttons: dtButtons })
